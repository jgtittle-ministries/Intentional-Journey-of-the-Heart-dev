...
**Participants who may feel assessed or judged.** The entire vocabulary of the Affective Taxonomy — stages, transitions, progression — can inadvertently communicate that some participants are "better" than others, more spiritually advanced, further along. This is the opposite of the LotS project's intention, and it is the opposite of the Image of God framework's anthropology: every participant is a fully connected image-bearer, whatever stage they are at. The facilitator training program addresses this directly, giving facilitators language for speaking about stage progression in ways that honor the dignity and the particular journey of every participant, at every stage. The deepest form of that language is the theological one: a participant's score measures their formation, never their standing before God, which for everyone in Christ is fixed and free — not earned, and not at risk (Rom. 8:1). Facilitators are trained to say this plainly whenever a profile is read back — especially a low or closure-flagged one — so that no instrument reading is ever heard as a verdict on whether God accepts the person. (This is the participant-care application of the guard stated in [§1](section-1-why-testing-matters-for-laws.md) and in [Vol 3's treatment of the Affective Taxonomy](../volume-3-quantitative-framework/exploration-04-spiritual-distance.md).)
...
Since this table was first written, four of the **Hearing-God Papers** have carried several of these questions forward at publication length — advancing the *understanding* behind the trails, even where the empirical program above is still the way to test them. [MSM — Measuring Spiritual Maturity in Hearing God](../volume-5-references/measuring-spiritual-maturity-in-hearing-god.md) formalizes the measurement argument behind **OT-1**, surveying six instruments against the Affective Taxonomy and naming the Levels 4–5 gap (though it is explicit that diagnosing the problem, its Stage 1, is not yet building the instruments, its Stage 2). [CSM — Cultivating Spiritual Maturity in Hearing God](../volume-5-references/cultivating-spiritual-maturity-in-hearing-god.md), with its applied halves [CTG — Clearing the Ground](../volume-5-references/clearing-the-ground-lower-levels.md) and [BFP — Bearing Fruit with Patience](../volume-5-references/bearing-fruit-with-patience-upper-levels.md), supplies the transition-by-transition cultivation pedagogy that **OT-4** calls for. And CTG's lower-level work — the emotional-knot account of the thorns and a new **Level −1** of active resistance — directly engages **OT-8**'s question of how sin and the adversary obstruct progression through the levels.
