...
### Awaiting comment-period close

!!! note "Mustard Seed Resolution — in its 14-day comment period · closes 2026-06-15"

    The V1.Exp8 / V3.Exp3.Open1 open question (threshold vs. proportionality) is **resolved toward the synthesis** and is now in its **14-day public comment period, closing 2026-06-15**. On close, V3.Exp3.Open1 flips to *resolved* and V1.Exp8's confidence is confirmed at 80.
