...
The Drawing-Near Reciprocity Law is the cleanest tension structure in the catalog: human drawing-near is paired with divine drawing-near, with reciprocity in direction but asymmetry in source (God is always the prior actor; the human seeking is itself a response to a prior divine invitation). The law deforms on both poles, in characteristic ways. (See [Supplemental: Reading the Laws as Held Tensions](supplemental-held-tensions-and-shadow-pairs.md) for the broader framing.)

**The over-pursued shadow: drawing near as anxious chase.** The person who has heard "draw near to God" and has set about drawing near with intensity — long hours of prayer, frenetic reading, an exhausting calendar of spiritual disciplines — is sometimes formed by the practice. But just as often, what looks like pursuit is anxious chase, and the underlying state is mistrust that God will actually meet the seeking. The "whole-hearted" qualifier in Jer. 29:13 cuts both ways here: it names what real seeking requires, and it exposes the seeking that is using the disciplines to manage anxiety rather than to draw near. The diagnostic: pursuit that does not settle when God does draw near is not pursuit at all; it is anxiety using the form of pursuit to evade the encounter the pursuit was supposed to produce.

**The under-pursued shadow: waiting as avoidance.** The opposite pole is the person who has heard "he will draw near to you" and has stopped at that. The 2 Chron. 15:2 inverse ("if you forsake him, he will forsake you") is named in the law as starkly as the positive direction, but the person in this shadow does not register as forsaking — they register, in their own self-account, as waiting. They are not running from God; they are just letting Him take the lead, which would be fine if the law did not specifically place the active verb on the human side. The waiting is a refusal of the law's named asymmetry. The diagnostic: spiritual stagnation that is described in waiting language ("when God wants me to draw closer, He will") is more often the under-pursued shadow than the patience it presents itself as.

The law's integrated operation is the person who draws near with whole heart, and who, when God draws near in return, settles into the proximity rather than running on past it. The pursuit is real and the receiving is real, and they are the same motion under different names.
