...
I am aware this model sits in tension with both the dichotomist and trichotomist positions in systematic theology. Grudem’s careful engagement with this question in Systematic Theology (Ch. 23) lands on a functional dichotomy — soul and spirit referring to the same immaterial part of persons, used interchangeably in scripture. My model departs from that: I propose a real functional distinction among spirit, heart, soul, and body, with soul as the comprehensive integrating entity rather than the spiritual component alone. The key texts I would ask a systematic theologian to examine with me are 1 Thess. 5:23, which explicitly distinguishes among the three (spirit, soul, body), and Heb. 4:12, which speaks of the Word dividing soul from spirit as if they were separable. I hold this model at Reasonably Inferred in part because I am not certain the systematic tradition has fully resolved the question this distinction is meant to answer.
...
**The ****spirit**** is the faculty by which a person deliberately attends and chooses ****to turn to ****God. It is**** the place where intention forms before behavior follows. It is the part of the heart in active communion with the Holy Spirit, and the part for which the person is held accountable in scripture. The distinction between spirit and the outer layers of the soul is functional more than substantive: spirit names the ****deliberate-attending-and-choosing operation that the soul as a whole includes but does not automatically perform.**
