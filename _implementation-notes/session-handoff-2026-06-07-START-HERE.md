...
- **FL.XXIX / XXXI / XXXII reification cluster** (four-tradition #29, low-pri) — name the **Holy Spirit (1 Cor. 12:13) / the person of Christ** as the binding agent of the "corporate soul/mind/heart," keeping Paul's body-language as organic metaphor, not a group over-soul. Best done as a **cluster pass** (all three together), not piecemeal. FL.XXIX already partly grounds it in "Christ's body" + Christ entering in.
