...
*The governance rule of the Intentional Journey of the Heart, adopted by the Council of Stewards on 6 September 2026*

**Status: in force.** Proposed to the Council as a draft dated 6 September 2026, heard and approved at the Council's second meeting that day (present: Barry Boyle, Dave Smith, John Tittle), and applied to the repository on John's word on 7 September 2026. The record is the first entry of the [Council Log](docs/volume-6-governance/council-log.md). The draft exactly as the Council saw it is [here](https://github.com/jgtittle-ministries/Intentional-Journey-of-the-Heart-dev/blob/9286a6e/_implementation-notes/council-meeting-2026-09-06/draft-governance-for-a-quiet-season.md).
...
What has arrived is this. Since the repository was created in April, every change has been made by John, with JD as technical maintainer and an AI assistant doing the mechanical work. No outside proposal has been received. No issue has been opened by anyone outside the project. Repository traffic is a trickle. The claim registry has never been reviewed by the Council. The schema and contributor guide drafted for the June meeting never moved to the repository root, and the contributor guide that was there still called itself a placeholder.
...
This rule therefore sets a light rule for the quiet season, keeps what still carries weight, shelves what does not, and names the trigger that would bring the heavier rule back.
...
- **Part 2 entire.** The Council as a Fellowship of the Heart, the meeting rhythm, the handling of disagreement, the Rule of Life. Nothing in this rule alters Part 2. This rule is an attempt to obey it.
- **The Succession Letter, which is the one thing that stays heavy.** A work carried by one person is most exposed exactly where Part 1 was most careful, and here the project is at its own rule: the letter names David R. Smith as Theological Successor and John David Tittle as Literary Executor. John signed it at the meeting of 6 September 2026, dated that day, before Barry Boyle and Dave Smith as witnesses; the signed original is kept with his estate papers, and copies go to each named successor as the letter provides. Alternates stay blank until he names them. JD, who already serves as the project's technical maintainer, holds that work within the Literary Executor's administrative custody, so no separate co-maintainer role needs inventing.
...
None of it is deleted. Part 1 stays in Volume 6 under a short preface, as the governance model held in reserve for a larger season.
...
Anyone may open an issue on the repository or write to John. A serious proposal is welcome and will be brought to the Council as an Ask at the next meeting, with the proposer told when that is. The Proposal Template remains available as a courtesy for anyone who wants to be thorough; it is not a gate. The one-page [CONTRIBUTING](CONTRIBUTING.md) file says exactly this.

---

## 7. The question this rule does not answer

Part 2 says the Council is under a spiritual authority that has yet to be identified and must be clarified before initiation. No procedure in this rule answers that, and no procedure could. It remains the one governance question that matters more than anything above. At the meeting of 6 September 2026 the Council took counsel on it and approved a stepwise approach; the Council Log records the steps and will record the outcome.

---

## 8. What adoption changed in the repository

Applied on John's word, 7 September 2026.

1. This file, the root `GOVERNANCE.md`, is the rule. It formerly said the project was in pre-Council operation and pointed readers to a superseded Word document.
2. The root `CONTRIBUTING.md` is a one-page version of §6.
3. Part 1 carries a short preface naming it as the model held in reserve, and the Volume 6 index describes it that way.
4. The Council Log exists in Volume 6, with the meeting of 6 September 2026 as its first entry.
5. The `last_council_review` field is removed from the four registry files.
6. The GitHub pull-request review workflow on the working repository is disabled, not deleted.
7. Part 3, dated 6 September 2026 and signed before witnesses, is on the published site. Alternates will be added when John names them.

---

*Proposed to the Council on 6 September 2026, approved that day, and applied to the repository on 7 September 2026. Any change to this rule is itself an Ask.*
